...
function getMovies(searchText) {
    ...
    axios.get('https://www.omdbapi.com?s='+ searchText+'&apikey=15edf019')
        ...
        $.each(movies, (index, movie) => {
          output += `
            <div class="col-md-4 wow animated-">
            <div class="card">
            <img src="${movie.Poster}" class="card-img-top img-fluid">
            <div class="card-body text-center">
            <h4 class="card-title text-center h4-responsive textcount" >${movie.Title}</h4>
            <a onclick="movieSelected('${movie.imdbID}')" class="btn original elegant-color btn-md" href="#">Movie Details</a>
            </div>
            </div> 
            </div>       
          `;
